...
settings = {'unifi_server':'localhost','unifi_user':'ubnt','unifi_pass':'ubnt','id':1,'unifi_server_ip':'127.0.0.1'}
...
def test_settings_api_admin_post(session,admin1_logged):
    '''Setting API POST call by Admin'''
    new_settings = {'unifi_server':'test.test.com','unifi_user':'ubntq','unifi_pass':'ubnta','id':1,'unifi_server_ip':'192.168.1.1'}
    #post  form
    check_api_post(url_for('admin.settings_api'),
                {'unifi_server':'test.test.com','unifi_user':'ubntq','unifi_pass':'ubnta','unifi_server_ip':'192.168.1.1'})
